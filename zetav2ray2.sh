...
while true; do
    ...
    case $yn in
        ...
        [Nn]* ) echo -e "\e[1;41mELIGIO NO INSTALAR BADVPN, SI DESEA INSTALAR, REINSTALE SCRIPT......\e[1;m" echo -e "\e[1;44mINSTALACION COMPLETADA......\e[1;m" echo -e "\e[1;44mINGRESE "V2RAY" PARA UTILIZAR EL PANEL ADMINISTRADOR......\e[1;m"; break;;
