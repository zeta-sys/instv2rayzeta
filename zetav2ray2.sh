...
while true; do
    ...
    case $yn in
        [Yy]* ) wget https://raw.githubusercontent.com/rockz5555/badvpn-installer/master/badvpn-installer.sh && bash badvpn-installer.sh && echo -e "\e[1;44mINSTALACION COMPLETADA......\e[1;m"; break;;
